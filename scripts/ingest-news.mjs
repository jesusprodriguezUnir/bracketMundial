...
// ─── 36 clubes UCL ────────────────────────────────────────────────────────────
const TEAMS = [
  { id: 'BVB', es: 'Borussia Dortmund', en: 'Borussia Dortmund', shortEs: 'Dortmund', shortEn: 'Dortmund' },
  { id: 'BAY', es: 'Bayern Múnich', en: 'Bayern Munich', shortEs: 'Bayern', shortEn: 'Bayern' },
  { id: 'VFB', es: 'VfB Stuttgart', en: 'VfB Stuttgart', shortEs: 'Stuttgart', shortEn: 'Stuttgart' },
  { id: 'ARS', es: 'Arsenal FC', en: 'Arsenal FC', shortEs: 'Arsenal', shortEn: 'Arsenal' },
  { id: 'AVL', es: 'Aston Villa', en: 'Aston Villa', shortEs: 'Aston Villa', shortEn: 'Villa' },
  { id: 'LIV', es: 'Liverpool FC', en: 'Liverpool FC', shortEs: 'Liverpool', shortEn: 'Liverpool' },
  { id: 'MCI', es: 'Manchester City', en: 'Manchester City', shortEs: 'Man City', shortEn: 'Man City' },
  { id: 'MUN', es: 'Manchester United', en: 'Manchester United', shortEs: 'Man United', shortEn: 'Man United' },
  { id: 'ATL', es: 'Atlético de Madrid', en: 'Atletico Madrid', shortEs: 'Atlético', shortEn: 'Atleti' },
  { id: 'BAR', es: 'FC Barcelona', en: 'FC Barcelona', shortEs: 'Barcelona', shortEn: 'Barca' },
  { id: 'RMA', es: 'Real Madrid', en: 'Real Madrid', shortEs: 'Real Madrid', shortEn: 'Real Madrid' },
  { id: 'BET', es: 'Real Betis', en: 'Real Betis', shortEs: 'Betis', shortEn: 'Betis' },
  { id: 'VIL', es: 'Villarreal CF', en: 'Villarreal CF', shortEs: 'Villarreal', shortEn: 'Villarreal' },
  { id: 'ROM', es: 'AS Roma', en: 'AS Roma', shortEs: 'Roma', shortEn: 'Roma' },
  { id: 'INT', es: 'Inter de Milán', en: 'Inter Milan', shortEs: 'Inter', shortEn: 'Inter' },
  { id: 'NAP', es: 'SSC Napoli', en: 'SSC Napoli', shortEs: 'Nápoles', shortEn: 'Napoli' },
  { id: 'SPO', es: 'Sporting Portugal', en: 'Sporting CP', shortEs: 'Sporting', shortEn: 'Sporting' },
  { id: 'FCP', es: 'FC Porto', en: 'FC Porto', shortEs: 'Porto', shortEn: 'Porto' },
  { id: 'LIL', es: 'Lille OSC', en: 'Lille OSC', shortEs: 'Lille', shortEn: 'Lille' },
  { id: 'PSG', es: 'Paris Saint-Germain', en: 'Paris Saint-Germain', shortEs: 'PSG', shortEn: 'PSG' },
  { id: 'RCL', es: 'RC Lens', en: 'RC Lens', shortEs: 'Lens', shortEn: 'Lens' },
  { id: 'GAL', es: 'Galatasaray', en: 'Galatasaray', shortEs: 'Galatasaray', shortEn: 'Galatasaray' },
  { id: 'FEN', es: 'Fenerbahçe', en: 'Fenerbahce', shortEs: 'Fenerbahçe', shortEn: 'Fenerbahce' },
  { id: 'PSV', es: 'PSV Eindhoven', en: 'PSV Eindhoven', shortEs: 'PSV', shortEn: 'PSV' },
  { id: 'FEY', es: 'Feyenoord', en: 'Feyenoord', shortEs: 'Feyenoord', shortEn: 'Feyenoord' },
  { id: 'RBL', es: 'RB Leipzig', en: 'RB Leipzig', shortEs: 'Leipzig', shortEn: 'Leipzig' },
  { id: 'BRU', es: 'Club Brujas', en: 'Club Brugge', shortEs: 'Brujas', shortEn: 'Brugge' },
  { id: 'SLP', es: 'Slavia Praga', en: 'Slavia Prague', shortEs: 'Slavia', shortEn: 'Slavia' },
  { id: 'SHK', es: 'Shakhtar Donetsk', en: 'Shakhtar Donetsk', shortEs: 'Shakhtar', shortEn: 'Shakhtar' },
  { id: 'AEK', es: 'AEK Atenas', en: 'AEK Athens', shortEs: 'AEK', shortEn: 'AEK' },
  { id: 'LSK', es: 'LASK Linz', en: 'LASK Linz', shortEs: 'LASK', shortEn: 'LASK' },
  { id: 'VIK', es: 'Viking FK', en: 'Viking FK', shortEs: 'Viking', shortEn: 'Viking' },
  { id: 'BOD', es: 'Bodø/Glimt', en: 'Bodo/Glimt', shortEs: 'Bodø/Glimt', shortEn: 'Bodo/Glimt' },
  { id: 'COM', es: 'Como 1907', en: 'Como 1907', shortEs: 'Como', shortEn: 'Como' },
  { id: 'SLO', es: 'Slovan Bratislava', en: 'Slovan Bratislava', shortEs: 'Slovan', shortEn: 'Slovan' },
  { id: 'SAB', es: 'Sabah FK', en: 'Sabah FK', shortEs: 'Sabah', shortEn: 'Sabah' },
];
...
const OFFICIAL_RSS = [
  { url: 'https://www.uefa.com/rssfeed/uefachampionsleague/rss.xml', source: 'UEFA', locale: 'en' },
  { url: 'https://feeds.bbci.co.uk/sport/football/rss.xml', source: 'BBC Sport', locale: 'en' },
  { url: 'https://e00-marca.uecdn.es/rss/futbol/champions-league.xml', source: 'Marca', locale: 'es' },
  { url: 'https://as.com/rss/futbol/champions.xml', source: 'AS', locale: 'es' },
];

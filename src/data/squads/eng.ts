...
export const squad: Player[] = [
  ...
  { number: 12, name: 'Trent Alexander-Arnold', position: 'MF', age: 28, club: 'Real Madrid' },
  ...
  { number: 24, name: 'Reece James', position: 'MF', age: 26, club: 'Chelsea' },
  ...
  { number: 25, name: 'Eberechi Eze', position: 'FW', age: 28, club: 'Crystal Palace' },

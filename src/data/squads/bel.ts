...
export const squad: Player[] = [
  { number: 1, name: 'Thibaut Courtois', position: 'GK', age: 34, club: 'Real Madrid' },
  ...
  { number: 13, name: 'Kevin De Bruyne', position: 'MF', age: 34, club: 'Napoli', captain: true },
  ...
  { number: 21, name: 'Mathias Fernandez-Pardo', position: 'FW', age: 21, club: 'Lille' },
...
export const lineup = {
  formation: '4-3-3',
  startingXI: [1, 9, 8, 12, 4, 13, 14, 16, 28, 22, 20]
};

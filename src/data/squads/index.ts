...
export const OFFICIAL_SQUADS: string[] = ['ESP', 'ARG', 'BIH', 'SWE', 'FRA', 'NZL', 'JPN', 'BEL', 'HAI', 'ENG', 'CZE', 'KOR', 'TUN', 'AUT', 'CUW', 'BRA', 'POR', 'SUI', 'EGY', 'GER', 'SEN', 'NOR', 'SCO', 'CPV', 'CRO', 'CIV', 'COL', 'NED', 'RSA', 'URU', 'MAR', 'PAR', 'USA'];

...
export const squad: Player[] = [
  ...
  { number: 4, name: 'Ramy Rabia', position: 'DF', age: 32, club: 'Al Ain' },
  ...
  { number: 17, name: 'Ahmed Sayed Zizo', position: 'MF', age: 30, club: 'Al Ahly' },
  { number: 19, name: 'Trézéguet', position: 'MF', age: 32, club: 'Al Ahly' },
  { number: 20, name: 'Ibrahim Adel', position: 'MF', age: 25, club: 'Nordsjaelland' },
  { number: 21, name: 'Mostafa Ziko', position: 'MF', age: 26, club: 'Pyramids' },
  { number: 24, name: 'Mohanad Lasheen', position: 'MF', age: 27, club: 'Pyramids' },
  { number: 25, name: 'Donga', position: 'MF', age: 28, club: 'Al Najma' },
  { number: 26, name: 'Mahmoud Saber', position: 'MF', age: 24, club: 'ZED FC' },
  { number: 10, name: 'Mohamed Salah', position: 'MF', age: 34, club: 'Liverpool' },
  { number: 9, name: 'Aktay Abdallah', position: 'FW', age: 23, club: 'ENPPI' },
  { number: 11, name: 'Omar Marmoush', position: 'FW', age: 27, club: 'Manchester City' },
  { number: 18, name: 'Hamza Abdelkarim', position: 'FW', age: 21, club: 'Barcelona B' },
];

...
export const squad: Player[] = [
  // Porteros
  { number: 1,  name: 'Guillermo Ochoa',       position: 'GK', age: 40, club: 'AEL Limassol' },
  { number: 12, name: 'Raúl Rangel',           position: 'GK', age: 26, club: 'Chivas' },
  ...
  { number: 21, name: 'Brian Gutiérrez',        position: 'DF', age: 23, club: 'Chivas' },
  ...
  { number: 18, name: 'Luis Romo',              position: 'MF', age: 30, club: 'Chivas' },
  ...
  { number: 7,  name: 'Germán Berterame',       position: 'FW', age: 27, club: 'Inter Miami' },

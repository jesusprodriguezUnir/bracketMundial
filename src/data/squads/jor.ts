...
export const squad: Player[] = [
  ...
  { number: 13, name: 'Saleem Amer Obaid', position: 'DF', age: 34, club: 'Al Hussein' },
  ...
  { number: 25, name: 'Anas Badawi', position: 'DF', age: 28, club: 'Al Faisaly' },
  { number: 5, name: 'Mohannad Abu Taha', position: 'DF', age: 23, club: 'Al Quwa Al Jawiya' },
  ...
  { number: 19, name: 'Rajaei Ayed', position: 'MF', age: 32, club: 'Al Hussein' },
  { number: 26, name: 'Amer Jamous', position: 'MF', age: 23, club: 'Al Wehdat' },
  { number: 27, name: 'Mohammad Al-Daowud', position: 'MF', age: 34, club: 'Al Wehdat' },

  { number: 9, name: 'Odeh Al Fakhouri', position: 'FW', age: 20, club: 'Pyramids' },
  ...
  { number: 20, name: 'Ali Al-Azaizeh', position: 'FW', age: 22, club: 'Al-Shabab' },
  { number: 21, name: 'Mohammad Abu Zrayq', position: 'FW', age: 28, club: 'Raja' },
];

export const lineup = {
  formation: '4-2-3-1',
  startingXI: [1, 2, 3, 4, 13, 8, 6, 16, 10, 18, 11]
};
...
export const squad: Player[] = [
  ...
  { number: 23, name: 'Mehdi Benabid', position: 'GK', age: 26, club: 'Raja Casablanca' },
  ...
  { number: 24, name: 'Jawad El Yamiq', position: 'DF', age: 33, club: 'Al-Wehda' },
  { number: 26, name: 'Zakaria El Ouahdi', position: 'DF', age: 24, club: 'Wydad Casablanca' },
  { number: 27, name: 'Ismael Baouf', position: 'DF', age: 22, club: 'Raja Casablanca' },
  ...
  { number: 28, name: 'Oussama Targhalline', position: 'MF', age: 23, club: 'Feyenoord' },
  ...
  { number: 29, name: 'Abde Ezzalzouli', position: 'FW', age: 24, club: 'Real Betis' },
  { number: 30, name: 'Chemsidine Talbi', position: 'FW', age: 22, club: 'Genk' },
  { number: 31, name: 'Yassir Zabiri', position: 'FW', age: 23, club: 'Nice' },
];

export const lineup = {
  formation: '4-2-3-1',
  startingXI: [1, 2, 4, 13, 3, 6, 8, 10, 29, 19, 7]
};

...
export const squad: Player[] = [
  ...
  { number: 25, name: 'José Luis Rodríguez', position: 'DF', age: 29, club: 'Vasco da Gama' },
  ...
  { number: 14, name: 'Joaquín Piquerez', position: 'MF', age: 27, club: 'Palmeiras' },
  { number: 19, name: 'Emiliano Martínez', position: 'MF', age: 26, club: 'Palmeiras' },
  { number: 21, name: 'Nicolás Fonseca', position: 'MF', age: 27, club: 'Real Oviedo' },
  { number: 26, name: 'Juan Manuel Sanabria', position: 'MF', age: 26, club: 'Real Salt Lake' },
  { number: 18, name: 'Agustín Canobbio', position: 'MF', age: 28, club: 'Fluminense' },
  ...
  { number: 20, name: 'Facundo Torres', position: 'FW', age: 26, club: 'Austin FC' },
  ...
  { number: 29, name: 'Agustín Álvarez Martínez', position: 'FW', age: 25, club: 'Monza' }
];

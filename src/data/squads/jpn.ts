...
export const squad: Player[] = [
  ...
  { number: 24, name: 'Leo Kokubo', position: 'GK', age: 22, club: 'Kashiwa Reysol' },
  ...
  { number: 27, name: 'Hidemasa Morita', position: 'MF', age: 30, club: 'Sporting CP' },
  { number: 28, name: 'Kodai Sano', position: 'MF', age: 23, club: 'Yokohama F. Marinos' },
  ...
  { number: 29, name: 'Shuto Machino', position: 'FW', age: 25, club: 'Shonan Bellmare' },
];

export const lineup = {
  formation: '3-4-3',
  startingXI: [12, 5, 4, 21, 17, 6, 8, 19, 20, 9, 11]
};

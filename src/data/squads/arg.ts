...
export const squad: Player[] = [
  ...
  { number: 25, name: 'Franco Mastantuono', position: 'MF', age: 19, club: 'Real Madrid' },
  { number: 26, name: 'Nico Paz', position: 'MF', age: 22, club: 'Como 1907' },
  ...
  { number: 17, name: 'Nico González', position: 'FW', age: 28, club: 'Atlético de Madrid' },

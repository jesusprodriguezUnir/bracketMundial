...
export const squad: Player[] = [
  ...
  { number: 23, name: 'Joan García', position: 'GK', age: 24, club: 'Espanyol' },
  ...
  { number: 5, name: 'Eric García', position: 'DF', age: 25, club: 'FC Barcelona' },
  ...
  { number: 20, name: 'Álex Baena', position: 'MF', age: 24, club: 'Atlético de Madrid' },
  { number: 25, name: 'Mikel Merino', position: 'MF', age: 30, club: 'Arsenal' },
  { number: 10, name: 'Dani Olmo', position: 'FW', age: 28, club: 'FC Barcelona' },
  ...
  { number: 21, name: 'Borja Iglesias', position: 'FW', age: 33, club: 'Celta de Vigo' },
  { number: 26, name: 'Víctor Muñoz', position: 'FW', age: 23, club: 'Real Madrid' },
];

export const lineup = {
  formation: '4-3-3',
  startingXI: [1, 3, 4, 14, 12, 16, 15, 8, 11, 9, 7]
};

...
export const squad: Player[] = [
  ...
  { number: 23, name: 'Moisés Ramírez',       position: 'GK', age: 25, club: 'AE Kifisias' },
  { number: 12, name: 'Gonzalo Valle',        position: 'GK', age: 30, club: 'Liga de Quito' },
  { number: 4,  name: 'Willian Pacho',        position: 'DF', age: 24, club: 'Paris Saint-Germain' },
  { number: 3,  name: 'Piero Hincapié',       position: 'DF', age: 24, club: 'FC Arsenal' },
  { number: 5,  name: 'Joel Ordóñez',         position: 'DF', age: 22, club: 'Clube Brugge' },
  ...
  { number: 21, name: 'Kendry Páez',          position: 'MF', age: 19, club: 'River Plate' },
  { number: 20, name: 'Nilson Angulo',        position: 'MF', age: 22, club: 'AFC Sunderland' },
  ...
  { number: 26, name: 'Anthony Valencia',     position: 'FW', age: 22, club: 'Royal Antwerp' },
  { number: 19, name: 'Kevin Rodríguez',      position: 'FW', age: 26, club: 'Union Saint-Gilloise' },
];

...
export const squad: Player[] = [
  ...
  { number: 3, name: 'Ali Adnan', position: 'DF', age: 33, club: 'Al-Minaa' },
  ...
  { number: 13, name: 'Mustafa Nadhim', position: 'DF', age: 31, club: 'Al-Shorta' },
  { number: 14, name: 'Hussein Ali', position: 'DF', age: 24, club: 'SC Heerenveen' },
  { number: 15, name: 'Mervan Celik', position: 'DF', age: 35, club: 'GAIS' },
  { number: 6, name: 'Osama Rashid', position: 'MF', age: 34, club: 'Vizela' },
  ...
  { number: 17, name: 'Aymen Hussein', position: 'MF', age: 30, club: 'Al-Wakrah' },
  ...
  { number: 11, name: 'Muntadher Mohammed', position: 'FW', age: 24, club: 'Al-Zawraa' },
  { number: 19, name: 'Ali Al-Hamadi', position: 'FW', age: 24, club: 'Ipswich Town' },
  { number: 20, name: 'Bashar Resan', position: 'FW', age: 29, club: 'Qatar SC' },
